...
//         TextEditingController(text: 'APPLICATON');
//     TextEditingController previewTextController =
//         TextEditingController(text: 'PREVIEW');
//     TextEditingController fromNameController =
//         TextEditingController(text: 'MANU');
//     TextEditingController fromEmailController =
//         TextEditingController(text: 'DIVYESH5262@GMAIL.COM');
...
//                         validator: (value) =>
//                             value!.isEmpty ? 'Please enter preview text' : null,
...
//                               flex: 4,
//                               onPress: () {
//                                 ref.watch(formdbProvider).storeFormdata(
//                                     FormDataModel(
...
class FormPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    GlobalKey<FormState> formKey = GlobalKey<FormState>();
    TextEditingController subjectController =
        TextEditingController(text: 'APPLICATION');
    TextEditingController previewTextController =
        TextEditingController(text: 'PREVIEW');
    TextEditingController fromNameController =
        TextEditingController(text: 'MANU');
                    ...
                    children: [
                      Align(
                        alignment: isTabletOrDesktop
                            ? Alignment.center
                            : Alignment.centerLeft,
                        child: Text(constants.txtbodytitle,
                            style: context.typography.body),
                      ),
                      SizedBox(height: context.spaces.space_150),
                      buildFieldLabel(context, constants.txtsbjct),
  ...
  Widget buildFieldLabel(BuildContext context, String label) {
    return Text(label, style: context.typography.body);
  }
}
